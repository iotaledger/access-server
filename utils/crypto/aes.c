...
case. For AES192/256 the key size is proportionally larger.
...
// storage instead of RAM The numbers below can be computed dynamically trading
// ROM for RAM - This can be useful in (embedded) bootloader applications,
