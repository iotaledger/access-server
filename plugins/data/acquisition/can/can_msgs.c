...
const int supported_body_msgs[] = {0x40,  0xB0,  0xE0,  0x100, 0x1B0, 0x250, 0x270, 0x310, 0x1D0,
                                   0x360, 0x380, 0x330, 0x259, 0x95,  0x1E0, 0x130, 0x160};

const int supported_chas_msgs[] = {0xD0, 0xE0, 0xF0, 0x3A0, 0x1C0, 0x1F0, 0x240, 0x2E0, 0x380,
                                   0x1A, 0x15, 0x35, 0x100, 0x110, 0x130, 0x210, 0x23A};
