...
void handleSocketRequest(int s, struct sockaddr_un *caddr, socklen_t caddrlen, unsigned char *request,
                         ssize_t requestLen, int shouldOpen) {
  unsigned int ifindex;
  canid_t tid;
  canid_t rid;
...
// Request dispatcher
static void handleMessage(int s, struct sockaddr_un *caddr, socklen_t caddrlen, unsigned char *request,
                          ssize_t requestLen) {
