...
void protocol_register_callback(acquire_fn acquire) { callback_acquire = acquire; }

void protocol_unregister_callback(void) { callback_acquire = NULL; }

void protocol_register_payment_state_callback(payment_status_fn trans_fn) { transaction_status = trans_fn; }

void protocol_unregister_payment_state_callback(void) { transaction_status = NULL; }
