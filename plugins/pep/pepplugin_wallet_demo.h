...
#ifndef _PEP_PLUGIN_WALLET_DEMO_H_
#define _PEP_PLUGIN_WALLET_DEMO_H_

#include "pep_plugin.h"

/**
 * @fn void peppluginwalletdemo_initializer(resolver_plugin_t* action_set)
