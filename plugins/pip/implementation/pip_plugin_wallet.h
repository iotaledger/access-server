 ...
 ****************************************************************************/
#ifndef __WALLET_PIP_PLUGIN_H__
#define __WALLET_PIP_PLUGIN_H__
#include "pip_plugin.h"
#include "wallet.h"

/**
 * @fn void wallet_pip_plugin_initializer(pep_plugin_t* probe_set)
 * @brief pip_plugin plugin initializer callback
 */
void wallet_pip_plugin_initializer(pip_plugin_t* probe_set);

/**
 * @fn void wallet_pip_plugin_terminator()
